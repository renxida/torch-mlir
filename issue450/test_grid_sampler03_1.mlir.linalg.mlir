...
module {
  ...
  func.func @test_grid_sampler03(%arg0: tensor<5x10x10x4xf32>, %arg1: tensor<5x7x8x2xf32>) -> tensor<?x?x?x?xf32> {
    ...
    ^bb0(%in: f32, %in_6: f32, %out: f32):
      %2 = arith.addf %in_6, %cst_0 : f32
      %3 = arith.addf %in, %cst_0 : f32
      %4 = arith.mulf %2, %cst_2 : f32
      %5 = arith.mulf %3, %cst_3 : f32
      ...
      %extracted_7 = tensor.extract %arg0[%28, %29, %24, %27] : tensor<5x10x10x4xf32>
      %32 = arith.select %21, %cst, %extracted_7 : f32
      %33 = arith.select %8, %cst, %32 : f32
      %extracted_8 = tensor.extract %arg0[%28, %29, %26, %25] : tensor<5x10x10x4xf32>
      %34 = arith.select %20, %cst, %extracted_8 : f32
      %35 = arith.select %9, %cst, %34 : f32
      %extracted_9 = tensor.extract %arg0[%28, %29, %26, %27] : tensor<5x10x10x4xf32>
      %36 = arith.select %20, %cst, %extracted_9 : f32
      ...
      %43 = arith.select %42, %31, %33 : f32
      %44 = arith.select %42, %35, %37 : f32
      %45 = arith.cmpf olt, %40, %cst_1 : f32
