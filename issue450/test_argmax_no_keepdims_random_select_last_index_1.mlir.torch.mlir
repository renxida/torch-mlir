module {
  func.func @test_argmax_no_keepdims_random_select_last_index(%arg0: !torch.vtensor<[2,3,4],f32>) -> !torch.vtensor<[2,4],si64> attributes {torch.onnx_meta.ir_version = 7 : si64, torch.onnx_meta.opset_version = 17 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
    ...
    %2 = torch.aten.argmax %1, %int1, %false : !torch.vtensor<[2,3,4],f32>, !torch.int, !torch.bool -> !torch.vtensor<[2,4],si64>
    %3 = torch.aten.sub.Scalar %2, %int2, %int1 : !torch.vtensor<[2,4],si64>, !torch.int, !torch.int -> !torch.vtensor<[2,4],si64>
    %4 = torch.aten.abs %3 : !torch.vtensor<[2,4],si64> -> !torch.vtensor<[2,4],si64>
    return %4 : !torch.vtensor<[2,4],si64>
  }
}
