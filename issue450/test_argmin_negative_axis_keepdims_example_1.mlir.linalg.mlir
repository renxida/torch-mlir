...
module {
  ...
  func.func @test_argmin_negative_axis_keepdims_example(%arg0: tensor<2x2xf32>) -> tensor<2x1xi64> {
    ...
    %expanded = tensor.expand_shape %4#1 [[0, 1]] output_shape [2, 1] : tensor<2xi64> into tensor<2x1xi64>
    return %expanded : tensor<2x1xi64>
  }
}
