...
#map1 = affine_map<(d0, d1, d2, d3, d4, d5) -> (d0, d1, d4, d3, d2, d5)>
#map2 = affine_map<(d0, d1, d2, d3, d4, d5) -> (d0, d1, d2, d4, d3, d5)>
#map3 = affine_map<(d0, d1, d2, d3, d4, d5) -> (d0, d1, d2, d3, d5, d4)>
module {
  ml_program.global private mutable @global_seed(dense<0> : tensor<i64>) : tensor<i64>
  func.func @test_depthtospace_crd_mode_example(%arg0: tensor<1x8x2x3xf32>) -> tensor<1x2x4x6xf32> {
