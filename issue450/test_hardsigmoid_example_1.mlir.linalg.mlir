...
module {
  ...
  func.func @test_hardsigmoid_example(%arg0: tensor<3xf32>) -> tensor<3xf32> {
    ...
    %4 = linalg.generic {indexing_maps = [#map2, #map, #map], iterator_types = ["parallel"]} ins(%3, %1 : tensor<f32>, tensor<3xf32>) outs(%0 : tensor<3xf32>) {
    ...
    %6 = linalg.generic {indexing_maps = [#map2, #map, #map], iterator_types = ["parallel"]} ins(%5, %4 : tensor<f32>, tensor<3xf32>) outs(%0 : tensor<3xf32>) {
    ^bb0(%in: f32, %in_2: f32, %out: f32):
