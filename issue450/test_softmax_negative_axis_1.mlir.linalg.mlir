...
module {
  ...
  func.func @test_softmax_negative_axis(%arg0: tensor<3x4x5xf32>) -> tensor<3x4x5xf32> {
    ...
    %11 = linalg.generic {indexing_maps = [#map, #map2, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%7, %10 : tensor<3x4x5xf32>, tensor<3x4x1xf32>) outs(%5 : tensor<3x4x5xf32>) {
    ^bb0(%in: f32, %in_1: f32, %out: f32):
