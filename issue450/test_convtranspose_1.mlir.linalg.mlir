...
module {
  ...
  func.func @test_convtranspose(%arg0: tensor<1x1x3x3xf32>, %arg1: tensor<1x2x3x3xf32>) -> tensor<1x2x5x5xf32> {
    ...
    %5 = tensor.empty() : tensor<1x2x5x5xf32>
    %6 = linalg.fill ins(%cst : f32) outs(%5 : tensor<1x2x5x5xf32>) -> tensor<1x2x5x5xf32>
    %7 = linalg.conv_2d_nchw_fchw {dilations = dense<1> : vector<2xi64>, strides = dense<1> : vector<2xi64>} ins(%inserted_slice, %2 : tensor<1x1x7x7xf32>, tensor<2x1x3x3xf32>) outs(%6 : tensor<1x2x5x5xf32>) -> tensor<1x2x5x5xf32>
    return %7 : tensor<1x2x5x5xf32>
  }
}
