...
module {
  ...
  func.func @test_argmin_negative_axis_keepdims_random_select_last_index(%arg0: tensor<2x3x4xf32>) -> tensor<2x3x1xi64> {
    ...
    ^bb0(%in: f32, %out: f32, %out_1: i64):
      ...
      %13 = arith.minimumf %in, %out : f32
      %14 = arith.cmpf olt, %in, %out : f32
