module {
  func.func @test_quantizelinear_ui8(%arg0: !torch.vtensor<[6],f32>, %arg1: !torch.vtensor<[],f32>, %arg2: !torch.vtensor<[],ui8>) -> !torch.vtensor<[6],ui8> attributes {torch.onnx_meta.ir_version = 9 : si64, torch.onnx_meta.opset_version = 19 : si64} {
    ...
    %2 = torch.aten.quantize_per_tensor %arg0, %0, %1, %int13 : !torch.vtensor<[6],f32>, !torch.float, !torch.int, !torch.int -> !torch.vtensor<[6],!torch.quint8>
    %3 = torch.aten.int_repr %2 : !torch.vtensor<[6],!torch.quint8> -> !torch.vtensor<[6],ui8>
    return %3 : !torch.vtensor<[6],ui8>
  }
}
