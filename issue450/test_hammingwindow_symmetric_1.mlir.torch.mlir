module {
  func.func @test_hammingwindow_symmetric(%arg0: !torch.vtensor<[],si32>) -> !torch.vtensor<[10],f32> attributes {torch.onnx_meta.ir_version = 8 : si64, torch.onnx_meta.opset_version = 17 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
    %float5.434780e-01 = torch.constant.float 5.434780e-01
    %float-4.565220e-01 = torch.constant.float -4.565220e-01
    ...
    %2 = torch.aten.mul.Scalar %0, %float0.000000e00 : !torch.vtensor<[],f32>, !torch.float -> !torch.vtensor<[],f32>
    %3 = torch.aten.mul.Scalar %1, %float1.000000e00 : !torch.vtensor<[],f32>, !torch.float -> !torch.vtensor<[],f32>
    ...
    %12 = torch.aten.mul.Scalar %10, %float-4.565220e-01 : !torch.vtensor<[10],f32>, !torch.float -> !torch.vtensor<[10],f32>
    %13 = torch.aten.mul.Scalar %11, %float0.000000e00 : !torch.vtensor<[10],f32>, !torch.float -> !torch.vtensor<[10],f32>
    %14 = torch.aten.add.Scalar %12, %float5.434780e-01, %float1.000000e00 : !torch.vtensor<[10],f32>, !torch.float, !torch.float -> !torch.vtensor<[10],f32>
