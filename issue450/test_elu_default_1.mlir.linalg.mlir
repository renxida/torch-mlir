...
module {
  ...
  func.func @test_elu_default(%arg0: tensor<3x4x5xf32>) -> tensor<3x4x5xf32> {
    ...
    %8 = linalg.generic {indexing_maps = [#map2, #map2, #map2], iterator_types = ["parallel", "parallel", "parallel"]} ins(%3, %7 : tensor<3x4x5xf32>, tensor<3x4x5xf32>) outs(%2 : tensor<3x4x5xf32>) {
    ^bb0(%in: f32, %in_2: f32, %out: f32):
      %9 = arith.addf %in, %in_2 : f32
      linalg.yield %9 : f32
    } -> tensor<3x4x5xf32>
    return %8 : tensor<3x4x5xf32>
  }
}
