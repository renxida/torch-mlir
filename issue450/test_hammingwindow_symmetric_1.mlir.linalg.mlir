...
module {
  ...
  func.func @test_hammingwindow_symmetric(%arg0: tensor<i32>) -> tensor<10xf32> {
    %cst = arith.constant 2.000000e+00 : f32
    %cst_0 = arith.constant 0.000000e+00 : f32
    %cst_1 = arith.constant 1.000000e+00 : f32
    %cst_2 = arith.constant 6.2831853071795862 : f64
    %cst_3 = arith.constant -4.565220e-01 : f64
    %cst_4 = arith.constant 5.434780e-01 : f64
    ...
    ^bb0(%in: f32, %out: f32):
      %16 = arith.subf %in, %cst_1 : f32
      linalg.yield %16 : f32
    } -> tensor<f32>
    %3 = linalg.generic {indexing_maps = [#map, #map], iterator_types = []} ins(%1 : tensor<f32>) outs(%0 : tensor<f32>) {
    ^bb0(%in: f32, %out: f32):
      %16 = arith.mulf %in, %cst_0 : f32
      linalg.yield %16 : f32
    } -> tensor<f32>
    %4 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = []} ins(%2, %3 : tensor<f32>, tensor<f32>) outs(%0 : tensor<f32>) {
    ...
    ^bb0(%in: f32, %out: f32):
      %16 = arith.truncf %cst_2 : f64 to f32
