module {
  func.func @test_gather_nd_1D_indices(%arg0: !torch.vtensor<[2,6,8,5],f32>, %arg1: !torch.vtensor<[2],si64>) -> !torch.vtensor<[8,5],f32> attributes {torch.onnx_meta.opset_version = 13 : si64} {
    ...
    %13 = torch.aten.broadcast_to %11, %12 : !torch.vtensor<[1,1,1],si64>, !torch.list<int> -> !torch.vtensor<[1,8,5],si64>
    %14 = torch.prim.ListConstruct %int-1, %int8, %int5 : (!torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %15 = torch.aten.view %arg0, %14 : !torch.vtensor<[2,6,8,5],f32>, !torch.list<int> -> !torch.vtensor<[12,8,5],f32>
    %16 = torch.aten.gather %15, %int0, %13, %false : !torch.vtensor<[12,8,5],f32>, !torch.int, !torch.vtensor<[1,8,5],si64>, !torch.bool -> !torch.vtensor<[1,8,5],f32>
    %17 = torch.aten.squeeze.dim %16, %int0 : !torch.vtensor<[1,8,5],f32>, !torch.int -> !torch.vtensor<[8,5],f32>
    return %17 : !torch.vtensor<[8,5],f32>
  }
}
